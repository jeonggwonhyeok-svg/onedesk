...
/// 2단계: 새 비밀번호 + 비밀번호 확인 → 비밀번호 변경
/// 3단계: 비밀번호 변경 완료 → 로그인하러 가기
library;
...
class _ResetPasswordPageState extends State<ResetPasswordPage> {
  ...
  bool get _isStep1Valid {
    return _isCodeSent && _codeController.text.trim().isNotEmpty;
  }

  /// 2단계 비밀번호 변경 버튼 활성화 여부
    ...
    return Column(
      ...
      children: [
        ...
        AuthMainButton(
          ...
          onPressed: _isStep2Valid && !_isInProgress ? _onResetPassword : null,
